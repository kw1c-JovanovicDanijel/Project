            ...
            <form method="POST" action="{{ route('address.store') }}">
                ...
                <div class="px-6 py-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input name="house_number" value="{{ old('house_number') }}" type="text" id="house_number"
                    ...
                    <div>
                        ...
                        <input name="street_name" value="{{ old('street_name') }}" type="text" id="street_name"
                            class="mt-1 block w-full rounded-lg border border-gray-700 bg-gray-800 text-white 
                                   shadow-sm focus:ring-2 focus:ring-[#ff9900] sm:text-sm sm:leading-6 px-3 py-1.5" />
                        @error('street_name')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input name="zip_code" value="{{ old('zip_code') }}" type="text" id="zip_code"
                            class="mt-1 block w-full rounded-lg border border-gray-700 bg-gray-800 text-white 
                                   shadow-sm focus:ring-2 focus:ring-[#ff9900] sm:text-sm sm:leading-6 px-3 py-1.5" />
                        @error('zip_code')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
