        ...
        <div class="flex-1 flex flex-col items-center justify-center text-center px-4">
            ...
            <div class="bg-gray-800 border border-gray-700 shadow-xl rounded-2xl p-8 max-w-md w-full text-left">
                ...
                @else
                    ...
                    @if ($order->status == \App\Enums\OrderStatus::BEZIG->name)
                        <!-- Knop nieuw product toevoegen -->
                        <div class="mt-4 flex justify-center">
                            <!-- TODO: product toevoegen pagina ofzo -->
                            <a href="#"
                        ...
                        <!-- TODO: haal weg als order klaar is, haal ook permissions weg voor een 404 error -->
                        <div class="mt-6 flex justify-center gap-3 items-center">
                            ...
                            <div class="relative flex items-center">
                                ...
                                <div
                                    ...
                                    <div
                                        class="bg-gray-800 rounded-xl shadow-xl max-w-md w-full p-6 text-center space-y-4">
